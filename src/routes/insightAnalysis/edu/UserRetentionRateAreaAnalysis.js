...
const COLUMN_ARRAY = [COLUMNS.area_name, COLUMNS.statistic_time,COLUMNS.section2_subtype_name]
const TITLE = '教育用户频道留存率分析'
const BIZ = 'education'
const BIZ_SUBTYPE = 'section2'

const UserRetentionRateAnalysis = () => {
  return (
    <SingleCompareTemplate title={TITLE} kpiGroup={KPI_GROUP} biz={BIZ} bizSubtype={BIZ_SUBTYPE} legendField={COLUMNS.section2_subtype_name.en} columnArr={COLUMN_ARRAY}/>
  )
}
