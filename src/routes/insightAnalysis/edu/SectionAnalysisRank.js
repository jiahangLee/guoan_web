...
const COLUMN_ARRAY = [COLUMNS.area_name, COLUMNS.statistic_time, COLUMNS.section1_type,COLUMNS.row_num]
const TITLE = '教育专区排行'
const BIZ = 'education'
const BIZ_SUBTYPE = 'sectionRank'

const SectionAnalysisRank = () => {
  return (
    <ManyKpiTemplate title={TITLE} kpiGroup={KPI_GROUP} biz={BIZ} bizSubtype={BIZ_SUBTYPE} legendField={COLUMNS.section1_type.en} columnArr={COLUMN_ARRAY} rowKeyField={COLUMNS.statistic_time.en+COLUMNS.section1_type.en} labelField={COLUMNS.section1_type.en}/>
  )
}

export default SectionAnalysisRank
