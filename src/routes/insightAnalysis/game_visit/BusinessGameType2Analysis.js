...
const COLUMN_ARRAY = [COLUMNS.area_name, COLUMNS.statistic_time, COLUMNS.game_visit_type2_name]
const TITLE = '二级类型用户分析'
const BIZ = 'game_visit'
const BIZ_SUBTYPE = 'type2'

const BusinessGameType2Analysis = () => {
  return (
    <ManyCompareTemplate title={TITLE} kpiGroup={KPI_GROUP} biz={BIZ} bizSubtype={BIZ_SUBTYPE}
                         legendField={COLUMNS.game_visit_type2_name.en} columnArr={COLUMN_ARRAY}
                         rowKeyField={COLUMNS.statistic_time.en + COLUMNS.game_visit_type2_name.en}/>
  )
}

export default BusinessGameType2Analysis
