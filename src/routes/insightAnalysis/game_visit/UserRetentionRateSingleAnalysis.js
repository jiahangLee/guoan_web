...
const TITLE = '单游戏用户留存率分析'
const BIZ = 'game_visit_rt'
const BIZ_SUBTYPE = 'single_game'

const UserRetentionRateSingleAnalysis = () => {
  return (
    <SingleCompareTemplate title={TITLE} kpiGroup={KPI_GROUP} biz={BIZ} bizSubtype={BIZ_SUBTYPE} legendField={COLUMNS.game_subtype_name.en} columnArr={COLUMN_ARRAY}/>
  )
}

export default UserRetentionRateSingleAnalysis
