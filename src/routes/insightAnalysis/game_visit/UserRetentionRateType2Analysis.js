...
const COLUMN_ARRAY = [COLUMNS.area_name, COLUMNS.statistic_time,COLUMNS.game_subtype_name2]
const TITLE = '二级类型用户留存率分析'
const BIZ = 'game_visit_rt'
const BIZ_SUBTYPE = 'type2'

const UserRetentionRateType2Analysis = () => {
  return (
    <SingleCompareTemplate title={TITLE} kpiGroup={KPI_GROUP} biz={BIZ} bizSubtype={BIZ_SUBTYPE} legendField={COLUMNS.game_subtype_name2.en} columnArr={COLUMN_ARRAY}/>
  )
}

export default UserRetentionRateType2Analysis
