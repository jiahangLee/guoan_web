...
const COLUMN_ARRAY = [COLUMNS.area_name, COLUMNS.statistic_time, COLUMNS.app_section_type2]
const TITLE = '二级应用分类分析'
const BIZ = 'app'
const BIZ_SUBTYPE = 'type2'

const businessAppType2Analysis = () => {
  return (
    <ManyCompareTemplate title={TITLE} kpiGroup={KPI_GROUP} biz={BIZ} bizSubtype={BIZ_SUBTYPE} legendField={COLUMNS.app_section_type2.en} columnArr={COLUMN_ARRAY} rowKeyField={COLUMNS.statistic_time.en+COLUMNS.app_section_type2.en}/>
  )
}

export default businessAppType2Analysis
