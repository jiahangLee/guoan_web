...
const COLUMN_ARRAY = [COLUMNS.area_name,COLUMNS.statistic_time,COLUMNS.app_subtype_name,COLUMNS.relation_business_name]
const TITLE = '应用用户流动分析'
const BIZ = 'app'
const BIZ_SUBTYPE = 'app'

const businessFlowTrendAPP = () => {
  return (
...
export default businessFlowTrendAPP
