...
const COLUMN_ARRAY = [COLUMNS.area_name,COLUMNS.statistic_time,COLUMNS.app_subtype_name1,COLUMNS.relation_business_name]
const TITLE = '一级应用用户流动分析'
const BIZ = 'app'
const BIZ_SUBTYPE = 'type1'

const businessFlowTrendType1 = () => {
  return (
...
export default businessFlowTrendType1
